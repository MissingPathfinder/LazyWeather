...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    let kKGDrawerCenterViewControllerStoryboardId = "CenterSC"
    let kKGLeftDrawerStoryboardId = "LeftSC"
    let kKGRightDrawerStoryboardId = "RightSC"
    ...
    func prepareDrawerViewController() -> KGDrawerViewController {
        ...
        drawerViewController.centerViewController = drawerCenterViewController()
    ...
    func drawerCenterViewController() -> UIViewController {
        let viewController = viewControllerForStoryboardId(kKGDrawerCenterViewControllerStoryboardId)
        return viewController
    }
...
//    }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "Ios.LazyWeather" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("LazyWeather", withExtension: "momd")!
